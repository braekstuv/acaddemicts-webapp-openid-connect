# Image Gallery App - Only show the OrderFrame Button for Free Users
...
✅ PKCE is enabled <br/>
✅ Only PayingUsers can see the OrderFrame Button <br/>
❌ Other Users can still access the OrderFrame page by URI <br/>
